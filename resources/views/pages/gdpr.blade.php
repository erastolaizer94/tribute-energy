    ...
    <section class="py-16 max-w-4xl mx-auto px-5 lg:px-8">
        <div class="space-y-8 text-gray-400 text-sm leading-relaxed" data-aos="fade-up">
            ...
            <div>
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-4 bg-[#111] border border-[#252525] p-5">
                        ...
                        <div><h3 class="font-rajdhani font-700 text-sm text-white mb-1">Right to Access</h3><p class="text-xs">You can request a copy of all personal data we hold about you at any time.</p></div>
                    </div>
                    <div class="flex items-start gap-4 bg-[#111] border border-[#252525] p-5">
                        ...
                        <div><h3 class="font-rajdhani font-700 text-sm text-white mb-1">Right to Rectification</h3><p class="text-xs">You can request that we correct any inaccurate or incomplete data.</p></div>
                    </div>
                    <div class="flex items-start gap-4 bg-[#111] border border-[#252525] p-5">
                        ...
                        <div><h3 class="font-rajdhani font-700 text-sm text-white mb-1">Right to Erasure</h3><p class="text-xs">You can request deletion of your personal data ("right to be forgotten").</p></div>
                    </div>
                    <div class="flex items-start gap-4 bg-[#111] border border-[#252525] p-5">
                        ...
                        <div><h3 class="font-rajdhani font-700 text-sm text-white mb-1">Right to Restrict Processing</h3><p class="text-xs">You can request that we limit how we use your data.</p></div>
                    </div>
                    <div class="flex items-start gap-4 bg-[#111] border border-[#252525] p-5">
                        ...
                        <div><h3 class="font-rajdhani font-700 text-sm text-white mb-1">Right to Data Portability</h3><p class="text-xs">You can request your data in a machine-readable format to transfer to another service.</p></div>
                    </div>
                    <div class="flex items-start gap-4 bg-[#111] border border-[#252525] p-5">
                        ...
                        <div><h3 class="font-rajdhani font-700 text-sm text-white mb-1">Right to Object</h3><p class="text-xs">You can object to processing of your data for marketing purposes at any time.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 mt-3">
                    <li class="flex items-start gap-3"><span class="text-[#FF6B00] mt-0.5">→</span><span><strong class="text-gray-300">Contract Performance:</strong> To fulfill orders and manage subscriptions.</span></li>
                    <li class="flex items-start gap-3"><span class="text-[#FF6B00] mt-0.5">→</span><span><strong class="text-gray-300">Consent:</strong> For marketing communications and optional cookies.</span></li>
                    <li class="flex items-start gap-3"><span class="text-[#FF6B00] mt-0.5">→</span><span><strong class="text-gray-300">Legitimate Interest:</strong> For analytics, fraud prevention, and site improvement.</span></li>
                    <li class="flex items-start gap-3"><span class="text-[#FF6B00] mt-0.5">→</span><span><strong class="text-gray-300">Legal Obligation:</strong> For tax and accounting compliance.</span></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="bg-[#111] border border-[#252525] p-5 mt-3 space-y-2">
                    <p class="text-sm"><i class="fas fa-envelope text-[#FF6B00] mr-2"></i><a href="mailto:privacy@tributeenergy.com" class="text-white hover:text-[#FF6B00]">privacy@tributeenergy.com</a></p>

...
@section('content')
    ...
    <section class="relative pt-20 pb-20 overflow-hidden bg-white">
        ...
        <div class="relative z-10 max-w-screen-xl mx-auto px-4 lg:px-8 text-center">
            <span class="inline-block px-4 py-1.5 text-xs font-bold tracking-wider uppercase rounded-full mb-5" style="background: #fff7ed; color: #FF8C00; border: 1px solid #ffedd5;">What We Do</span>
